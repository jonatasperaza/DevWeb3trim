...
import GlobalCarousel from '@/components/HomeView/GlobalCarousel.vue';
import BigCarousel from '@/components/HomeView/BigCarousel.vue';
...
await moviesStore.getMoreMovies()
})
